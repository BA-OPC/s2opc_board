...
SOPC_PubSubConfiguration* SOPC_PubSubConfig_Batch_GetStatic(double interval)
{
    ...
    if (alloc)
    {
        ...
        writerGroup = SOPC_PubSubConfig_SetPubMessageAt(connection, 0, 15, 1,interval <=0 ? 1000.000000 : interval, -1, SOPC_SecurityMode_Sign, NULL, SOPC_MessageEncodeUADP, 0);
